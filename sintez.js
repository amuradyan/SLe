...
const evaluate = (expression) => {
  ...
  if (Array.isArray(expression)) {
    if (expression[0] === atom("define")) {
      // Add a new definition to the beginning of the environment /head/
      // Don't forget to evaluate the value the name is bound to

      throw new Error("🪈 Error: Implement me!.");
    } else {
